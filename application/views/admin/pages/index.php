<main>
    <div class="container">
        <section class="forms-block content">
            <h1>Формы</h1>
            <div class="forms-menu">
                <h2 class="forms-menu-item selected"
                    data-show="add-the-driver-form">
                    Добавление в базу
                </h2>
                <h2 class="forms-menu-item"
                    data-show="add-the-fine-form">
            ...
            <div class="forms-container">
                ...
                <form style="display: none" id="add-the-fine-form" name="fine_form">
