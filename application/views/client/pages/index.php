            ...
            <div class="fines-container">
                ...
                <div class="fines-list" id="unpaid-list" style="display: block;">
                    ...
                    <form id="fines-payment-form" name="fines-payment-form">
                        <ul>
                            <?php foreach ($car_offenses as $offense):
                                if (!$offense['status']): ?>
                                    <li class="fine-payment-wrap-block">
                                        <div class="fine-payment-wrap">
                                            ...
                                            <div class="fine-date-and-time">
                                                <p>
                                                    <img class="date-and-time-svg" src="images\calendar-regular.svg"
                                                         alt="calendar">
                                                ...
                                                <p>
                                                    <img class="date-and-time-svg" src="images\clock-regular.svg"
                                                         alt="clock">
                                            ...
                                            <div class="fine-pay-bill-amount">
                                                <?php if ($now < $offense['last_bill_date']): ?>
                                                    <?php if ($now < $offense['gis_discount_uptodate']): ?>
                                                        <p>
                                                            <b><span><?= $offense['pay_bill_amount'] / 2 ?></span> ₽</b>
                                                        </p>
                                                        <p class="success">
                                                            -50% до
                                            ...
                                            <div class="fine-details">
                                                <span>Детали</span>
                                                <img class="arrow down" src="images\chevron-down-solid.svg" alt="arrow">
                                            </div>
                                        </div>
                        ...
                        <div class="payment-block">
                            ...
                            <p><b>Итого к оплате с учётом скидки:</b> <span id="final-amount">0</span> руб.</p>
                                ...
                                <li class="fine-payment-wrap-block">
                                    <div class="fine-payment-wrap">
                                        ...
                                        <div class="fine-car-info" style="display: none">
                                            <p><span><?= 'Название авто' ?></span></p>
                                            <p>
                                                <span><?= 'Рег. номер' ?></span> <span><?= 'Рег. регион' ?></span>
                                            </p>
                                        </div>
                                        <div class="fine-pay-bill-amount">
                                            <p>
                                            ...
                                            <p>
                                                оплачен
                                                <time datetime="<?= $offense['last_bill_date'] ?>">
                                                    <?= date('d.m', strtotime($offense['last_bill_date'])) ?>
                                                </time>
                                            </p>
                                        </div>
                                        <div class="fine-details">
